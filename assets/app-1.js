...
(function () {
  ...
  var WORKFLOWS = [
    ...
    /* ==================================================================== */
    {
      ...
      rows: [
        { issue: false,
          ...
          after: ['SPC-88412', 'John Doe', { b: 'At lab: accessioning', t: 'lab' },
                  'None &mdash; lab holds this', 'Lab', 'Today 3:00 PM',
        ...
        { issue: false,
          ...
          after: ['SPC-88413', 'Jane Smith', { b: 'In transit to lab', t: 'flat' },
                  'None &mdash; courier holds this', 'Courier', 'Arrives 1:00 PM',
        ...
        { issue: true,
          ...
          after: ['SPC-88414', 'Robert Brown', { b: 'Insufficient sample', t: 'error' },
                 ...
                 'None &mdash; scheduling holds this', 'Scheduling', 'Today 12:00 PM',
        ...
        { issue: false,
          ...
          after: ['SPC-88415', 'Maria Lopez', { b: 'Released to reporting', t: 'lab' },
                  'None &mdash; reporting holds this', 'Lab', 'Today 5:00 PM',
                  { a: 'View chain', k: 'info' }] }
      ],
      ...
      panel: {
        ...
        fields: [
          ...
          ['Recollection order', null, 'Ordered &mdash; today 12:00 PM']
        ],
      ...
      fixed: 'A status that names the stage and who holds it, with Owner, Due and one action ' +
             'on the same row pattern &mdash; and a required action only on the rows that are the ' +
      ...
      rows: [
        { issue: false,
          before: ['RES-30281', 'John Doe', 'MRD panel', { b: 'Alert', t: 'error' }, '2h ago',
                   { a: 'View', k: 'link' }],
          after: ['RES-30281', 'John Doe', { b: 'Normal &mdash; no action', t: 'flat' },
                  'None &mdash; filed to the chart', 'System', 'Filed 2h ago',
                  { a: 'View result', k: 'info' }] },

        { issue: false,
          before: ['RES-30282', 'Jane Smith', 'CGP panel', { b: 'Alert', t: 'error' }, '3h ago',
                   { a: 'Open report', k: 'ghost' }],
          after: ['RES-30282', 'Jane Smith', { b: 'Abnormal &mdash; review', t: 'review' },
        ...
        { issue: true,
          before: ['RES-30283', 'Robert Brown', 'MRD panel', { b: 'Alert', t: 'error' }, '25m ago',
                   { a: '&hellip;', k: 'menu', raw: 1 }],
          after: ['RES-30283', 'Robert Brown', { b: 'Critical &mdash; action required', t: 'error' },
                  'Contact the patient today', 'A. Smith', 'Today 11:00 AM',
                  { a: 'Start contact', k: 'recovery' }],
          done: ['RES-30283', 'Robert Brown', { b: 'Critical &mdash; signed off', t: 'provider' },
                 'None &mdash; contact recorded', 'A. Smith', 'Today 11:00 AM',
                 { a: 'View result', k: 'provider' }] },

        { issue: false,
          before: ['RES-30284', 'Maria Lopez', 'Hereditary panel', { b: 'Alert', t: 'error' }, '6h ago',
                   { a: 'Download', k: 'ghost' }],
          after: ['RES-30284', 'Maria Lopez', { b: 'Normal &mdash; no action', t: 'flat' },
                  'None &mdash; filed to the chart', 'System', 'Filed 6h ago',
                  { a: 'View result', k: 'info' }] }
      ],
    ...
    /* ==================================================================== */
    {
      ...
      broke: 'The action moved from row to row &mdash; a control in the last column, a link ' +
             'inside the detail cell, an overflow menu &mdash; and Open, Pending and Active ' +
